...
const Success = () => {
  return (
    <div className='flex flex-col justify-center items-center w-full h-full'>
      ...
      <h2 className='font-inter  text-white  text-3xl mt-10 '>Verification Successful!</h2>
      ...
      <button className='bg-pink-700 hover:bg-pink-700 text-white font-bold py-2 px-6 flex mb-7'>
